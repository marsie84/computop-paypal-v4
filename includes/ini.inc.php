 ...
 * Paygate credentials
 */
$MerchantID = "paypal_test";                // via e-mail from computop support
$BlowfishPassword = "z!7CWf]83_AgQ9b?";   // via phone from computop support
$HmacPassword = "Jc8?2]qGQ7*n(Er35z)H=4Da9p[Y!6Tk";           // via phone from computop support
